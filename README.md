...
**cinematic bullet cam**, procedural sound, mission dossiers, a results screen,
and mobile touch controls. The entire scene (city, rooftop, rifle, targets, HUD,
audio, reticle) is **generated by code**, so the project needs **zero downloaded
assets** and **zero Inspector wiring**.
